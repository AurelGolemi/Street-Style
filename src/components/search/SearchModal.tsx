...
export default function SearchModal({ isOpen, onClose }: SearchModalProps) {
  ...
  const trendingSearches = ['Nike Air Max', 'Adidas Ultraboost', 'Hoodies', 'Running Shoes']
        ...
        <div className="max-h-[500px] overflow-y-auto p-6">
          {searchQuery === '' ? (
            ...
            <div>
              ...
              {/* Popular Products */}
              <div className="mt-8">
                <h3 className="font-semibold text-gray-900 mb-4">Popular Products</h3>
            ...
            <div className="text-center py-12">
              ...
              <div className="flex flex-wrap gap-2 justify-center">
                {['Men', 'Women', 'Kids', 'Shoes', 'Clothing'].map((category) => (
                  <Link
                    key={category}
